...
rootDir = '/media/public/Datasets/original_datasets/MDDPHCED/files'
...
db = lmdb.open('/media/public/Datasets/original_datasets/MDDPHCED/processed_lmdb_75hz', map_size=1273741824)
