...
train_dir = '/media/public/Datasets/original_datasets/BCIC2020-3/Training_set'
val_dir = '/media/public/Datasets/original_datasets/BCIC2020-3/Validation_set'
test_dir = '/media/public/Datasets/original_datasets/BCIC2020-3/Test_set'
...
db = lmdb.open('/media/public/Datasets/cbramod_data/test', map_size=3000000000)
...
df = pd.read_excel("/media/public/Datasets/original_datasets/BCIC2020-3/Track3_Answer Sheet_Test.xlsx")
df_=df.head(53)
