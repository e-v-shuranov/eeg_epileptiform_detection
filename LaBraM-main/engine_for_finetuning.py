...
def evaluate_for_mbt_binary_scenario(data_loader, model, device, header='Test:', ch_names=None, metrics=['acc'],
    ...
    models:
     ...
     2 Wavelet : XGB_model
    datasets:
     1 TUEV         is_mbt - 6 classes   # 0,1,2 - seizures  3,4,5 - artefacts ( 5 - may be no events)
     2 Siena
     3 matb_ii
     4 example_mbt     (only half banana)
     5 example_clinic  (only half banana)
    parameters:
     use_thresholds_for_artefacts  / threshold_for_artefacts  /threshold_for_epilepsy
     """
